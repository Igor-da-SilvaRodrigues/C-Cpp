...
void toArray(int* array, CelulaLista* inicio);

CelulaLista *Inicio;

int main(){
	Inicio = NULL;
	int v, old, opcao, tam = 0, tamReal = 0;
	int* array;
	...
	while (1){
		...
		switch(opcao){
			...
			case 3://toArray
				tamReal = tam;
				array = new int[tamReal];
				toArray(array, Inicio);
				break;
			case 4:
				printf("////////\n");
